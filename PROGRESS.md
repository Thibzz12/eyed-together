...
_Toute la totalité du cahier des charges est visée (demande explicite de Thibaud le 2026-07-23) — ordre de traitement choisi par moi : Événements (fait) → Boîte à idées (fait) → Liens utiles (fait) → Recherche globale (fait) → Quiz (fait) → Médias (fait) → Notifications → Cockpit admin avancé (en dernier, car il agrège les données des autres modules)._
